...
Demo | Building Blocks | Local | Azure | AWS | GCP | Language
--- | --- | --- | --- | --- | --- | ---:
[Binding](./demo_binding.code-workspace) | [Bindings](https://docs.dapr.io/developing-applications/building-blocks/bindings/) | File Share | Azure Storage | AWS S3 | GCP Storage Bucket| HTTP
